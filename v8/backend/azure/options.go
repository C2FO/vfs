...
type Options struct {
	...
	// RetryFunc holds the retry function (same shape as v7 vfs.Retry).
	//
	// Deprecated: This field is deprecated and will be removed in a future release.
	RetryFunc func(func() error) error //nolint:staticcheck // Deprecated: This field is deprecated and will be removed in a future release.
