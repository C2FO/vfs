...
Rely on github.com/c2fo/vfs/v7/backend
	  ...
	  import(
		  ...
		  "github.com/c2fo/vfs/v8/backend/ftp"
	  )
...
Passwords may be passed via Options.Password or via the environmental variable *VFS_FTP_PASSWORD*.  If no password is provided,
