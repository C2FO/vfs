...
// Development only: resolve the parent module when working inside the vfs repository.
// Drop this line when tagging releases if you publish v8 as a standalone module.
