...
import (
	authority "github.com/c2fo/vfs/v7/utils/authority"
	mock "github.com/stretchr/testify/mock"

	options "github.com/c2fo/vfs/v7/options"

	regexp "regexp"

	vfs "github.com/c2fo/vfs/v7"
	fs "io/fs"
)
...
// Authority provides a mock function with no fields
func (_m *Location) Authority() authority.Authority {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() authority.Authority); ok {
		r0 = rf()
	} else {
...
func (_c *Location_Authority_Call) Return(_a0 authority.Authority) *Location_Authority_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *Location) Open(name string) (fs.File, error) {
	ret := _m.Called(name)
...
// Location_Open_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Open'
type Location_Open_Call struct {
	*mock.Call
}

// Open is a helper method to define mock.On call
//   - name string
func (_e *Location_Expecter) Open(name interface{}) *Location_Open_Call {
	return &Location_Open_Call{Call: _e.mock.On("Open", name)}
}

func (_c *Location_Open_Call) Run(run func(name string)) *Location_Open_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *Location_Open_Call) Return(_a0 fs.File, _a1 error) *Location_Open_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Location_Open_Call) RunAndReturn(run func(string) (fs.File, error)) *Location_Open_Call {
	_c.Call.Return(run)
	return _c
}
