...
// Close provides a mock function for the type DataConn
func (_mock *DataConn) Close() error {
	ret := _mock.Called()
...
func (_c *DataConn_Close_Call) Return(err error) *DataConn_Close_Call {
	_c.Call.Return(err)
	return _c
}
...
// Delete provides a mock function for the type DataConn
func (_mock *DataConn) Delete(path string) error {
...
func (_c *DataConn_Delete_Call) Return(err error) *DataConn_Delete_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *DataConn_Delete_Call) RunAndReturn(run func(path string) error) *DataConn_Delete_Call {
	_c.Call.Return(run)
	return _c
}

// GetEntry provides a mock function for the type DataConn
func (_mock *DataConn) GetEntry(p string) (*ftp.Entry, error) {
	ret := _mock.Called(p)
...
func (_c *DataConn_GetEntry_Call) Return(entry *ftp.Entry, err error) *DataConn_GetEntry_Call {
	_c.Call.Return(entry, err)
	return _c
}

func (_c *DataConn_GetEntry_Call) RunAndReturn(run func(p string) (*ftp.Entry, error)) *DataConn_GetEntry_Call {
	_c.Call.Return(run)
	return _c
}

// IsSetTimeSupported provides a mock function for the type DataConn
func (_mock *DataConn) IsSetTimeSupported() bool {
	ret := _mock.Called()
...
func (_c *DataConn_IsSetTimeSupported_Call) Return(b bool) *DataConn_IsSetTimeSupported_Call {
	_c.Call.Return(b)
	return _c
}
...
// IsTimePreciseInList provides a mock function for the type DataConn
func (_mock *DataConn) IsTimePreciseInList() bool {
	ret := _mock.Called()
...
func (_c *DataConn_IsTimePreciseInList_Call) Return(b bool) *DataConn_IsTimePreciseInList_Call {
	_c.Call.Return(b)
	return _c
}
...
// List provides a mock function for the type DataConn
func (_mock *DataConn) List(p string) ([]*ftp.Entry, error) {
	ret := _mock.Called(p)
...
func (_c *DataConn_List_Call) Return(entrys []*ftp.Entry, err error) *DataConn_List_Call {
	_c.Call.Return(entrys, err)
	return _c
}

func (_c *DataConn_List_Call) RunAndReturn(run func(p string) ([]*ftp.Entry, error)) *DataConn_List_Call {
	_c.Call.Return(run)
	return _c
}

// MakeDir provides a mock function for the type DataConn
func (_mock *DataConn) MakeDir(path string) error {
	ret := _mock.Called(path)
...
func (_c *DataConn_MakeDir_Call) Return(err error) *DataConn_MakeDir_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *DataConn_MakeDir_Call) RunAndReturn(run func(path string) error) *DataConn_MakeDir_Call {
	_c.Call.Return(run)
	return _c
}

// Mode provides a mock function for the type DataConn
func (_mock *DataConn) Mode() types.OpenType {
	ret := _mock.Called()
	...
	if returnFunc, ok := ret.Get(0).(func() types.OpenType); ok {
		r0 = returnFunc()
	} else {
...
func (_c *DataConn_Mode_Call) Return(openType types.OpenType) *DataConn_Mode_Call {
	_c.Call.Return(openType)
	return _c
}
...
// Read provides a mock function for the type DataConn
func (_mock *DataConn) Read(p []byte) (int, error) {
	ret := _mock.Called(p)
...
func (_c *DataConn_Read_Call) RunAndReturn(run func(p []byte) (int, error)) *DataConn_Read_Call {
	_c.Call.Return(run)
	return _c
}

// Rename provides a mock function for the type DataConn
func (_mock *DataConn) Rename(from string, to string) error {
...
func (_c *DataConn_Rename_Call) Return(err error) *DataConn_Rename_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *DataConn_Rename_Call) RunAndReturn(run func(from string, to string) error) *DataConn_Rename_Call {
	_c.Call.Return(run)
	return _c
}

// SetTime provides a mock function for the type DataConn
func (_mock *DataConn) SetTime(path string, t time.Time) error {
...
func (_c *DataConn_SetTime_Call) Return(err error) *DataConn_SetTime_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *DataConn_SetTime_Call) RunAndReturn(run func(path string, t time.Time) error) *DataConn_SetTime_Call {
	_c.Call.Return(run)
	return _c
}

// Write provides a mock function for the type DataConn
func (_mock *DataConn) Write(p []byte) (int, error) {
	ret := _mock.Called(p)
...
func (_c *DataConn_Write_Call) RunAndReturn(run func(p []byte) (int, error)) *DataConn_Write_Call {
	_c.Call.Return(run)
	return _c
}
