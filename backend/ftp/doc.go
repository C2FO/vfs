...
Rely on github.com/c2fo/vfs/v5/backend
  ...
  import(
	  ...
	  "github.com/c2fo/vfs/v5/backend/ftp"
  )
...
Or call directly:
  ...
  import "github.com/c2fo/vfs/v5/backend/ftp"
...
environmental variables VFS_FTP_KEYFILE and VFS_FTP_KEYFILE_PASSPHRASE, respectively.
...
2. Options.KnownHostsFile or environmental variable VFS_FTP_KNOWN_HOSTS_FILE which accepts a path to a known_hosts file.
3. Options.KnownHostsCallback which allows you to specify any of the ssh.AuthMethod functions.  Environmental variable
   VFS_FTP_INSECURE_KNOWN_HOSTS will set this callback function to ssh.InsecureIgnoreHostKey which may be helpful
